...
// ValidationResult holds the result of validating a downloaded file.
...
// ValidateDownloadedFile checks whether a downloaded file is valid.
// It checks file size and (for FLAC files) duration to detect previews.
func ValidateDownloadedFile(filePath string) ValidationResult {
	...
	if err != nil {
		// Non-FLAC files or parse errors: accept the file
