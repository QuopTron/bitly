...
func TestIsPlayableCachedFile(t *testing.T) {
	...
	if !esArchivoCacheReproducible(flac) {
	...
	if esArchivoCacheReproducible(mp4AsFlac) {
	...
	if !esArchivoCacheReproducible(mp3) {
	...
	if !esArchivoCacheReproducible(ogg) {
	...
	if !esArchivoCacheReproducible(plainMP4) {
	...
	if esArchivoCacheReproducible(enc) {
