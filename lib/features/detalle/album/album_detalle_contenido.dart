// ─────────────────────────────────────────────────────────────
// album_detalle_contenido.dart — PART de album_detalle_pagina.dart:
// children de la cabecera — barra de progreso del lote en curso,
// banner de solo-descargados cuando no hay red y la lista de tracks
// (TarjetaTrack con like/descarga/borrar/reproducir/compartir y la
// carátula resuelta por like o la del álbum).
// Se conecta con: album_detalle_pagina.dart (misma library) +
// tarjeta_track + hoja_opciones_descarga + share_plus.
// Parte del flujo: Detalle → álbum (contenido).
// ─────────────────────────────────────────────────────────────
