// ─────────────────────────────────────────────────────────────
// panel_error.dart — Panel de error del splash NATIVO (Android/TV/PC).
//
// Qué hace: muestra el mensaje de error + botón reintentar. El backend
// va dentro de la app, así que un fallo es transitorio y reintentar
// tiene sentido. La variante WEB vive en panel_error_web.dart.
//
// Se conecta con: splash_bloc + l10n.
