...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Bitly needs storage permission to save your downloaded music files.'**
  ...
  /// Snackbar - file unavailable when offline
  ///
  /// In en, this message translates to:
  /// **'\"{title}\" is not available offline'**
  String snackbarFileUnavailableOffline(String title);

  /// Snackbar - file could not be resolved via API
  ///
  /// In en, this message translates to:
  /// **'Could not stream \"{title}\"'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Please select a .Bitly-ext file'**
  ...
  /// Tooltip - play online fallback button
  ///
  /// In en, this message translates to:
  /// **'Play online'**
  String get tooltipPlayOnline;
  ...
  ///
  /// In en, this message translates to:
  /// **'Install .Bitly-ext files to add new providers'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Bitly needs storage access to scan your music library. Please grant permission in settings.'**
  ...
  /// Badge for tracks downloaded via Bitly
  ///
  /// In en, this message translates to:
  /// **'Downloaded'**
  ...
  /// Filter bubble for all items
  ///
  /// In en, this message translates to:
  /// **'All'**
  String get collectionAll;

  /// Filter bubble for songs
  ///
  /// In en, this message translates to:
  /// **'Songs'**
  String get collectionSongs;

  /// Filter bubble for albums
  ///
  /// In en, this message translates to:
  /// **'Albums'**
  String get collectionAlbums;

  /// Filter bubble for artists
  ///
  /// In en, this message translates to:
  /// **'Artists'**
  String get collectionArtists;
  ...
  ///
  /// In en, this message translates to:
  /// **'Bitly now uses Android Storage Access Framework (SAF) for downloads. This fixes \"permission denied\" errors on Android 10+.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Saves to Music/Bitly by default'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Downloading Bitly Mobile v{version}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Bitly Mobile v{version} downloaded. Tap to install.'**
