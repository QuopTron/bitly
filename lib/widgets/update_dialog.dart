  ...
  Future<void> _downloadAndInstall() async {
    ...
    final filePath = await ApkDownloader.downloadApk(
      ...
      onProgress: (received, total) {
        ...
        NotificationUpdate.showUpdateDownloadProgress(
          version: widget.updateInfo.version,
          received: received,
          total: total,
        );
    ...
    if (filePath != null) {
      await NotificationUpdate.cancelUpdateNotification();
      
      await NotificationUpdate.showUpdateDownloadComplete(
        version: widget.updateInfo.version,
      );
      ...
      await NotificationUpdate.showUpdateDownloadFailed();
