...
AppSettings _$AppSettingsFromJson(Map<String, dynamic> json) => AppSettings(
  ...
  downloadVideo: json['downloadVideo'] as bool? ?? false,
  ...
  separateSingles: json['separateSingles'] as bool? ?? true,
  albumFolderStructure: json['albumFolderStructure'] as String? ?? 'album',
  username: json['username'] as String? ?? '',
  isPremium: json['isPremium'] as bool? ?? false,
  premiumUntil: (json['premiumUntil'] as num?)?.toInt() ?? 0,
  premiumCode: json['premiumCode'] as String? ?? '',
);
...
Map<String, dynamic> _$AppSettingsToJson(
  ...
  'premiumCode': instance.premiumCode,
};
