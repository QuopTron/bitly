class StringsSetup {
  ...
  final String verificationTitle, verificationDesc, verificationStart, verificationVerify, verificationDone, verifyingProvider, verificationFailed;
  final String noFolder, unknownTrack, secondsAbbrev;
  // ── Feed ────────────────────────────────────────────────────
  final String feedGoodMorning, feedGoodAfternoon, feedGoodEvening, feedNoContent;
  // ── Mi Espacio ──────────────────────────────────────────────
  final String miSpaceGuest;
  final String miSpaceSongs, miSpacePlaylists, miSpaceAlbums, miSpaceArtists;
  final String miSpaceEmptySongs, miSpaceEmptyPlaylists, miSpaceEmptyAlbums, miSpaceEmptyArtists;
  final String miSpaceSongCount, miSpacePlaylistCount;
  final String miSpaceArtist, miSpacePlaylist;
  final String labelAll, labelLiked, labelFav;
  // ── Search ──────────────────────────────────────────────────
  final String searching, noResults, recentSearches, clear;
  // ── Settings ─────────────────────────────────────────────────
  final String settings, theme, darkMode, lightMode, languageSetting, downloadFolder, premiumStatus, likedSongs, downloaded;
  final String downloadSettings, audioQuality, videoDownload, lyricsDownload, videoQuality, lyricsSource;
  final String quickDownloadLabel;
  final String flac, high, medium, low;
  final String performanceProfile, perfLow, perfMedium, perfHigh, perfLowDesc, perfMediumDesc, perfHighDesc;
  ...
  const StringsSetup({
    ...
    required this.verificationTitle, required this.verificationDesc, required this.verificationStart,
    required this.verificationVerify, required this.verificationDone, required this.verifyingProvider,
    required this.verificationFailed,
    required this.noFolder, required this.unknownTrack, required this.secondsAbbrev,
    required this.feedGoodMorning, required this.feedGoodAfternoon, required this.feedGoodEvening, required this.feedNoContent,
    required this.miSpaceGuest,
    required this.miSpaceSongs, required this.miSpacePlaylists, required this.miSpaceAlbums, required this.miSpaceArtists,
    required this.miSpaceEmptySongs, required this.miSpaceEmptyPlaylists, required this.miSpaceEmptyAlbums, required this.miSpaceEmptyArtists,
    required this.miSpaceSongCount, required this.miSpacePlaylistCount,
    required this.miSpaceArtist, required this.miSpacePlaylist,
    required this.labelAll, required this.labelLiked, required this.labelFav,
    required this.searching, required this.noResults, required this.recentSearches, required this.clear,
    required this.settings, required this.theme, required this.darkMode, required this.lightMode,
    required this.languageSetting, required this.downloadFolder, required this.premiumStatus,
    required this.likedSongs, required this.downloaded,
    required this.downloadSettings, required this.audioQuality, required this.quickDownloadLabel,
    required this.videoDownload, required this.lyricsDownload, required this.videoQuality, required this.lyricsSource,
    required this.flac, required this.high, required this.medium, required this.low,
    required this.performanceProfile, required this.perfLow, required this.perfMedium, required this.perfHigh,
    required this.perfLowDesc, required this.perfMediumDesc, required this.perfHighDesc,
    required this.enabled, required this.disabled,
  ...
  static const en = StringsSetup(
    ...
    verificationDesc: 'Some music providers need you to verify you\'re human. Tap "Start" to verify all at once — it\'s just one captcha.',
    ...
    noFolder: 'No folder', unknownTrack: 'Unknown', secondsAbbrev: 's',
    feedGoodMorning: 'Good morning', feedGoodAfternoon: 'Good afternoon', feedGoodEvening: 'Good evening', feedNoContent: 'No content',
    miSpaceGuest: 'Guest',
    miSpaceSongs: 'Songs', miSpacePlaylists: 'Playlists', miSpaceAlbums: 'Albums', miSpaceArtists: 'Artists',
    ...
    miSpaceSongCount: 'songs', miSpacePlaylistCount: 'playlists',
    miSpaceArtist: 'Artist', miSpacePlaylist: 'Playlist',
    labelAll: 'All', labelLiked: 'Liked', labelFav: 'Fav',
    searching: 'Searching...', noResults: 'No results', recentSearches: 'Recent', clear: 'Clear',
    settings: 'Settings', theme: 'Theme', darkMode: 'Dark', lightMode: 'Light',
    languageSetting: 'Language', downloadFolder: 'Download folder', premiumStatus: 'Premium',
    likedSongs: 'Liked', downloaded: 'Downloaded',
    downloadSettings: 'Downloads', audioQuality: 'Audio quality',
    quickDownloadLabel: 'Quick download (skip options)',
    videoDownload: 'Download video', lyricsDownload: 'Download lyrics',
    videoQuality: 'Video quality', lyricsSource: 'Lyrics source',
    flac: 'FLAC (CD quality)', high: 'High (192 kbps)',
    medium: 'Medium (128 kbps)', low: 'Low (64 kbps)',
    performanceProfile: 'Performance',
    perfLow: 'Low', perfMedium: 'Medium', perfHigh: 'High',
    ...
    preferredLyricsSource: 'Preferred lyrics source. All available sources will be queried.',
    resetData: 'Reset all data',
    resetDataTitle: 'Reset all data?',
    resetDataMessage: 'This will delete ALL your data: favorites, playlists, downloads, settings, and everything else.\n\nThe app will restart from scratch as if it were the first time.',
    cancel: 'Cancel',
    ...
    downloadDecryptFailed: 'A download could not be decrypted (FFmpeg unavailable). Redownload the track to fix it.',
    ok: 'OK',
  );

  static const es = StringsSetup(
    selectLanguage: 'Selecciona tu idioma', chooseLanguage: 'Elige el idioma de la app', continueText: 'Continuar',
    espanol: 'Español', english: 'English', chooseMode: 'Elige tu modo de uso', free: 'Gratis', premium: 'Premium',
    ...
    activate: 'Activar', back: 'Atrás', next: 'Siguiente', invalidCode: 'Código inválido', codeActivated: '¡Premium activado!',
    returningUser: '¿Es esta tu cuenta? ¿Quieres continuar con ella?', yes: 'Sí', no: 'No',
    ...
    chooseUsername: '¿Cómo deberíamos llamarte?', usernameHint: 'Ingresa tu nombre',
    ...
    verificationDesc: 'Algunos proveedores necesitan que verifiques que eres humano. Toca "Iniciar" para verificar todo de una vez — es solo un captcha.',
    ...
    verificationFailed: 'Verificación fallida para {provider}. Intenta de nuevo.',
    noFolder: 'Ninguna carpeta', unknownTrack: 'Desconocido', secondsAbbrev: 's',
    feedGoodMorning: 'Buen día', feedGoodAfternoon: 'Buena tarde', feedGoodEvening: 'Buena noche', feedNoContent: 'Sin contenido',
    miSpaceGuest: 'Invitado',
    miSpaceSongs: 'Canciones', miSpacePlaylists: 'Playlists', miSpaceAlbums: 'Álbumes', miSpaceArtists: 'Artistas',
    ...
    miSpaceSongCount: 'canciones', miSpacePlaylistCount: 'playlists',
    miSpaceArtist: 'Artista', miSpacePlaylist: 'Playlist',
    labelAll: 'Todas', labelLiked: 'Likeado', labelFav: 'Fav',
    searching: 'Buscando...', noResults: 'Sin resultados', recentSearches: 'Recientes', clear: 'Limpiar',
    settings: 'Ajustes', theme: 'Tema', darkMode: 'Oscuro', lightMode: 'Claro',
    languageSetting: 'Idioma', downloadFolder: 'Carpeta de descargas', premiumStatus: 'Premium',
    likedSongs: 'Likeadas', downloaded: 'Descargadas',
    downloadSettings: 'Descargas', audioQuality: 'Calidad de audio',
    quickDownloadLabel: 'Descarga directa (saltar opciones)',
    videoDownload: 'Descargar video', lyricsDownload: 'Descargar letra',
    videoQuality: 'Calidad de video', lyricsSource: 'Fuente de letras',
    flac: 'FLAC (Calidad CD)', high: 'Alta (192 kbps)',
    medium: 'Media (128 kbps)', low: 'Baja (64 kbps)',
    performanceProfile: 'Rendimiento',
    perfLow: 'Bajo', perfMedium: 'Medio', perfHigh: 'Alto',
    ...
    preferredLyricsSource: 'Fuente preferida de letras. Se consultarán todas las fuentes disponibles.',
    resetData: 'Restablecer todos los datos',
    resetDataTitle: '¿Restablecer todos los datos?',
    resetDataMessage: 'Esto eliminará TODOS tus datos: favoritos, playlists, descargas, ajustes y todo lo demás.\n\nLa app se reiniciará desde cero como si fuera la primera vez.',
    cancel: 'Cancelar',
    ...
    downloadDecryptFailed: 'No se pudo descifrar una descarga (FFmpeg no disponible). Reintenta la descarga para repararla.',
    ok: 'OK',
  );
}
