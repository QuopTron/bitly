...
class TrackCard extends StatelessWidget {
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: Colors.white.withValues(alpha: 0.1), width: 0.7),
              ...
              if (readyKey != null && readyKey!.isNotEmpty)
                Positioned(
                  ...
                  child: ValueListenableBuilder<Set<String>>(
                    ...
                    builder: (context, ready, _) => ready.contains(readyKey)
                        ? Container(
                            padding: EdgeInsets.symmetric(horizontal: 6, vertical: 2),
                            decoration: BoxDecoration(
                              color: Colors.black.withValues(alpha: 0.55),
                              borderRadius: BorderRadius.circular(10),
                              border: Border.all(color: const Color(0xFF4CAF50).withValues(alpha: 0.6), width: 0.6),
                            ),
                            child: Row(mainAxisSize: MainAxisSize.min, children: [
                              Icon(Icons.bolt, size: r.footerSize - 2, color: const Color(0xFF66BB6A)),
                              SizedBox(width: 3),
                              Text(loc.setup.readyBadge,
                                style: TextStyle(fontSize: r.footerSize - 3, fontWeight: FontWeight.w700, color: const Color(0xFF81C784))),
                            ]),
                          )
                ...
                children: [
                  ClipRRect(
                    ...
                    child: Container(
                      ...
                      child: coverUrl != null
                          ? imageFromUrl(coverUrl, fit: BoxFit.cover, fallback: Icon(Icons.music_note, color: fallbackIconColor, size: 34))
                          : Icon(Icons.music_note, color: fallbackIconColor, size: 34),
                    ),
                  ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          title,
                          style: TextStyle(fontSize: r.subtitleSize * ts, fontWeight: FontWeight.w600, color: textColor),
                          maxLines: 1,
                        ...
                        Text(
                          subtitle,
                          style: TextStyle(fontSize: (r.footerSize - 1) * ts, color: mutedColor),
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                        ),
                      ],
                  ...
                  if (showActions) _actionCluster(context, r, loc, iSize, mutedColor, textColor),
                ],
              ),
            ),
          ],
  ...
  Widget _actionCluster(BuildContext context, Responsive r, AppLocalizations loc,
      double iSize, Color mutedColor, Color textColor) {
    Widget cluster = Row(
      mainAxisSize: MainAxisSize.min,
      children: [
        DownloadIndicator(
        ...
        Tooltip(
          ...
          child: GestureDetector(
            onTap: downloadState == DownloadState.completed && onDelete != null
                ? onDelete : onDownload,
            child: Icon(
              downloadState == DownloadState.completed
