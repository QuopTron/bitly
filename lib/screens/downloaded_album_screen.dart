...
class _DownloadedAlbumScreenState extends ConsumerState<DownloadedAlbumScreen> {
  ...
  Widget _buildTrackItem(
    ...
    return TrackCard(
      ...
      onTap: _isSelectionMode
          ...
          : () {
               ...
               ref.read(audioPlayerProvider.notifier).play(
                 ...
                 albumName: track.albumName,
                 coverUrl: track.coverUrl,
                 provider: track.service ?? 'download',
                 isrc: track.isrc,
               );
               
               // Pre-cargar video y letra EN PARALELO (sin bloquear el audio)
               Future(() {
                 ref.read(audioPlayerProvider.notifier).prefetchVideo(track.trackName, track.artistName);
      ...
      onToggleSelect: (_) => _toggleSelection(track.id),
    );
  }
