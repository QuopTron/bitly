        ...
        body: CustomScrollView(
          slivers: [
            ...
            SliverToBoxAdapter(
              child: SettingsGroup(
                children: [
                  // Concurrent downloads section removed as requested - downloads are now strictly sequential
                  SettingsItem(
                    icon: Icons.download_for_offline,
                    title: context.l10n.optionsConcurrentDownloads,
                    subtitle: context.l10n.optionsConcurrentSequential,
                    showDivider: true,
                    onTap: null, // Just informative now
                  ),
                  SettingsItem(
                    icon: Icons.wifi,
              ...
              child: SettingsGroup(
                children: [
                   SettingsSwitchItem(
                    ...
                    title: 'Descargar Letra',
                    subtitle: 'Extrae y guarda la letra sincronizada en el archivo',
                  ...
                  SettingsSwitchItem(
                    ...
                    subtitle: settings.downloadVideo
                        ? 'Descarga el video musical de YouTube si está disponible'
                        : 'No se descargará el video musical',
