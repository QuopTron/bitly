  ...
  static _LyricsProviderInfo _getLyricsProviderInfo(
    ...
    switch (id) {
      ...
      case 'genius':
        return _LyricsProviderInfo(
          name: 'Genius',
          description: 'Search lyrics from Genius.com',
          icon: Icons.auto_awesome,
        );
      case 'azlyrics':
        return _LyricsProviderInfo(
          name: 'AZLyrics',
          description: 'Search lyrics from AZLyrics.com',
          icon: Icons.text_fields,
        );
      case 'lyricsfreak':
        return _LyricsProviderInfo(
          name: 'LyricsFreak',
          description: 'Search lyrics from LyricsFreak.com',
          icon: Icons.format_quote,
        );
      case 'metrolyrics':
        return _LyricsProviderInfo(
          name: 'MetroLyrics',
          description: 'Search lyrics from MetroLyrics.com',
          icon: Icons.music_video,
        );
      case 'songteksten':
        return _LyricsProviderInfo(
          name: 'SongTeksten',
          description: 'Search lyrics from SongTeksten.nl',
          icon: Icons.lyrics,
        );
      default:
        return _LyricsProviderInfo(
