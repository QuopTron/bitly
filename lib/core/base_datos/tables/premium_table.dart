// ---------------------------------------------------------------------------
// premium_table.dart — Tablas de premium: estado del usuario, uso de cuota y reproducciones diarias. Se conecta con: daos/premium_dao.dart + backend Go (sync premium). Parte del flujo: premium gate (descargas) y limites diarios.
// ---------------------------------------------------------------------------
