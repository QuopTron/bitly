// ---------------------------------------------------------------------------
// content_tables.dart — Tablas de contenido musical: artistas, albums y canciones (FK e indices). Se conecta con: daos/content_dao.dart. Parte del flujo: biblioteca local (Mi Espacio).
// ---------------------------------------------------------------------------
