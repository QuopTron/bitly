// ---------------------------------------------------------------------------
// sources_table.dart — Tablas de fuentes (proveedor + id externo) y archivos locales. Se conecta con: daos/content_dao.dart. Parte del flujo: biblioteca local y reproduccion de archivos.
// ---------------------------------------------------------------------------
