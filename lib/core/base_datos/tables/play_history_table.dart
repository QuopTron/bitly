// ---------------------------------------------------------------------------
// play_history_table.dart — Tablas de historial de reproduccion (eventos) y agregados (contador por item). Se conecta con: daos/play_history_dao.dart. Parte del flujo: Mi Espacio > Recientes/Estadisticas.
// ---------------------------------------------------------------------------
