// ---------------------------------------------------------------------------
// download_tables.dart — Tablas de descargas: cola, historial, lotes (batch) e ids ocultos. Se conecta con: daos/download_dao.dart + DownloadCubit. Parte del flujo: descargas (Mi Espacio y boton de descarga).
// ---------------------------------------------------------------------------
