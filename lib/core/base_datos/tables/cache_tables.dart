// ---------------------------------------------------------------------------
// cache_tables.dart — Tablas de cache generico: ISRC, URLs de video y JSON (detalles + libreria). Se conecta con: daos/cache_dao.dart. Parte del flujo: cache de vistas de detalle y libreria.
// ---------------------------------------------------------------------------
