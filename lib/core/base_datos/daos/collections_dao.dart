// ---------------------------------------------------------------------------
// collections_dao.dart — DAO de colecciones (playlists del usuario) y sus items. Se conecta con: app_database.dart + PlaylistCubit. Parte del flujo: Mi Espacio > Playlists.
// ---------------------------------------------------------------------------
