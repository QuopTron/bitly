// ---------------------------------------------------------------------------
// cache_dao.dart — DAO de caches: ISRC, URLs de video y JSON generico. Se conecta con: app_database.dart + caches de detalle/busqueda. Parte del flujo: cache de vistas de detalle y libreria.
// ---------------------------------------------------------------------------
