...
import 'package:bitly/core/bridge/bridge_models.dart';
import 'package:bitly/core/bridge/decoder_bridge.dart';
import 'package:bitly/utils/logger.dart';

export 'package:bitly/core/bridge/bridge_models.dart';
export 'package:bitly/core/bridge/decoder_bridge.dart';
...
class PlatformBridge {
  ...
  static Future<dynamic> invoke(String method, [dynamic args]) async {
    return _invokeI(method, args);
  }

  static Future<dynamic> _invokeI(String method, [dynamic args]) async {
    if (_useHttpBackend) {
  ...
  static Future<Map<String, dynamic>> checkAvailability(
    ...
    if (cacheKey.isEmpty) {
      ...
      final result = await _invokeI('checkAvailability', {
  ...
  static Future<void> cancelExtensionRequest(String requestId) async {
    if (requestId.isEmpty) return;
    await _invokeI('cancelExtensionRequestJSON', {'request_id': requestId});
  }
  ...
  static Future<Map<String, dynamic>> _invokeDownloadMethod(
    ...
    final result = await _invokeI(method, request);
  ...
  static Future<Map<String, dynamic>> getDownloadProgress() async {
    final result = await _invokeI('getDownloadProgress');
    return decodeMapResult(result);
  }

  static Future<Map<String, dynamic>> getAllDownloadProgress() async {
    final result = await _invokeI('getAllDownloadProgress');
    return decodeMapResult(result);
  }
  ...
  static Future<void> exitApp() async {
    await _invokeI('exitApp');
  }

  static Future<void> initItemProgress(String itemId) async {
    await _invokeI('initItemProgress', {'item_id': itemId});
  }

  static Future<void> finishItemProgress(String itemId) async {
    await _invokeI('finishItemProgress', {'item_id': itemId});
  }

  static Future<void> clearItemProgress(String itemId) async {
    await _invokeI('clearItemProgress', {'item_id': itemId});
  }

  static Future<void> cancelDownload(String itemId) async {
    await _invokeI('cancelDownload', {'item_id': itemId});
  }

  static Future<void> setDownloadDirectory(String path) async {
    await _invokeI('setDownloadDirectory', {'path': path});
  }
  ...
  static Future<void> setNetworkCompatibilityOptions({
    ...
    await _invokeI('setNetworkCompatibilityOptions', {
  ...
  static Future<Map<String, dynamic>> checkDuplicate(
    ...
    final result = await _invokeI('checkDuplicate', {
  ...
  static Future<String> buildFilename(
    ...
    final result = await _invokeI('buildFilename', {
      'template': template,
  ...
  static Future<String> sanitizeFilename(String filename) async {
    final result = await _invokeI('sanitizeFilename', {'filename': filename});
    return result as String;
  }
  ...
  static Future<Map<String, dynamic>> resolveSafFile({
    ...
    final result = await _invokeI('resolveSafFile', {
      'tree_uri': treeUri,
  ...
  static Future<String?> copyContentUriToTemp(String uri) async {
    final result = await _invokeI('safCopyToTemp', {'uri': uri});
    return result as String?;
  }
  ...
  static Future<bool> replaceContentUriFromPath(
    ...
    final result = await _invokeI('safReplaceFromPath', {
      'uri': uri,
      'src_path': srcPath,
    });
    return result as bool;
  ...
  static Future<String?> createSafFileFromPath({
    ...
    final result = await _invokeI('safCreateFromPath', {
      'tree_uri': treeUri,
      'relative_dir': relativeDir,
      'file_name': fileName,
      'mime_type': mimeType,
  ...
  static Future<void> openContentUri(String uri, {String mimeType = ''}) async {
    await _invokeI('openContentUri', {'uri': uri, 'mime_type': mimeType});
  }

  static Future<bool> shareContentUri(String uri, {String title = ''}) async {
    final result = await _invokeI('shareContentUri', {
      'uri': uri,
      'title': title,
    });
  ...
  static Future<bool> shareMultipleContentUris(
    ...
    final result = await _invokeI('shareMultipleContentUris', {
      'uris': uris,
      'title': title,
    });
    return result as bool? ?? false;
  ...
  static Future<Map<String, dynamic>> downloadCoverToFile(
    ...
    final result = await _invokeI('downloadCoverToFile', {
      'cover_url': coverUrl,
  ...
  static Future<Map<String, dynamic>> extractCoverToFile(
    ...
    final result = await _invokeI('extractCoverToFile', {
  ...
  static Future<Map<String, dynamic>> reEnrichFile(
    ...
    final result = await _invokeI('reEnrichFile', {'request_json': requestJSON});
  ...
  static Future<Map<String, dynamic>> readFileMetadata(String filePath) async {
    final result = await _invokeI('readFileMetadata', {'file_path': filePath});
  ...
  static Future<Map<String, dynamic>> editFileMetadata(
    ...
    final result = await _invokeI('editFileMetadata', {
      'file_path': filePath,
  ...
  static Future<Map<String, dynamic>> rewriteSplitArtistTags(
    ...
    final result = await _invokeI('rewriteSplitArtistTags', {
      'file_path': filePath,
      'artist': artist,
  ...
  static Future<bool> writeTempToSaf(String tempPath, String safUri) async {
    final result = await _invokeI('writeTempToSaf', {
      'temp_path': tempPath,
      'saf_uri': safUri,
    });
  ...
  static Future<void> startDownloadService({
    ...
    await _invokeI('startDownloadService', {
  ...
  static Future<void> stopDownloadService() async {
    await _invokeI('stopDownloadService');
  }
  ...
  static Future<void> updateDownloadServiceProgress({
    ...
    await _invokeI('updateDownloadServiceProgress', {
      'track_name': trackName,
      'artist_name': artistName,
      'progress': progress,
      'total': total,
  ...
  static Future<bool> isDownloadServiceRunning() async {
    final result = await _invokeI('isDownloadServiceRunning');
    return result as bool;
  }
  ...
  static Future<void> startNativeDownloadWorker({
    ...
    try {
      await _invokeI('startNativeDownloadWorker', {
  ...
  static Future<void> pauseNativeDownloadWorker() async {
    await _invokeI('pauseNativeDownloadWorker');
  }

  static Future<void> resumeNativeDownloadWorker() async {
    await _invokeI('resumeNativeDownloadWorker');
  }

  static Future<void> cancelNativeDownloadWorker() async {
    await _invokeI('cancelNativeDownloadWorker');
  }

  static Future<Map<String, dynamic>> getNativeDownloadWorkerSnapshot() async {
    final result = await _invokeI('getNativeDownloadWorkerSnapshot');
    return decodeMapResult(result);
  }
  ...
  static Future<String> searchYouTubeVideo({
    ...
    final result = await _invokeI('searchYouTubeVideo', {
      'track_name': trackName,
      'artist_name': artistName,
    });
    return result as String;
  ...
  static Future<String> searchTidalVideo({
    ...
    final result = await _invokeI('searchTidalVideo', {
      'track_name': trackName,
      'artist_name': artistName,
    });
    return result as String;
  ...
  static Future<String> searchQobuzVideo({
    ...
    final result = await _invokeI('searchQobuzVideo', {
      'track_name': trackName,
      'artist_name': artistName,
    });
    return result as String;
  ...
  static Future<String> downloadYouTubeVideo({
    ...
    final result = await _invokeI('downloadYouTubeVideo', {
      'track_name': trackName,
      'artist_name': artistName,
      'output_path': outputPath,
    });
  ...
  static Future<void> cleanupConnections() async {
    await _invokeI('cleanupConnections');
  }
  ...
  static Future<Map<String, dynamic>> fetchLyrics(
    ...
    final result = await _invokeI('fetchLyrics', {
      'spotify_id': spotifyId,
      'track_name': trackName,
      'artist_name': artistName,
  ...
  static Future<String> getLyricsLRC(
    ...
    final result = await _invokeI('getLyricsLRC', {
      'spotify_id': spotifyId,
      'track_name': trackName,
      'artist_name': artistName,
      'file_path': filePath ?? '',
  ...
  static Future<String> getTranslatedLyricsLRC(
    ...
    final result = await _invokeI('getTranslatedLyricsLRC', {
      'spotify_id': spotifyId,
      'track_name': trackName,
      'artist_name': artistName,
      'duration_ms': durationMs,
  ...
  static Future<void> setTranslationLanguage(String language) async {
    await _invokeI('setTranslationLanguageJSON', {'language': language});
  }

  static Future<String> getTranslationLanguage() async {
    final result = await _invokeI('getTranslationLanguageJSON', {});
    return result as String;
  }
  ...
  static Future<Map<String, dynamic>> getLyricsLRCWithSource(
    ...
    final result = await _invokeI('getLyricsLRCWithSource', {
      'spotify_id': spotifyId,
      'track_name': trackName,
      'artist_name': artistName,
      'file_path': filePath ?? '',
  ...
  static Future<Map<String, dynamic>> embedLyricsToFile(
    ...
    final result = await _invokeI('embedLyricsToFile', {
      'file_path': filePath,
      'lyrics': lyrics,
    });
  ...
  static Future<Map<String, dynamic>> fetchAndSaveLyrics({
    ...
    final result = await _invokeI('fetchAndSaveLyrics', {
      'track_name': trackName,
      'artist_name': artistName,
      'spotify_id': spotifyId,
      'duration_ms': durationMs,
  ...
  static Future<void> setLyricsProviders(List<String> providers) async {
    ...
    await _invokeI('setLyricsProvidersJSON', {'providers_json': providersJSON});
  }

  static Future<List<String>> getLyricsProviders() async {
    final result = await _invokeI('getLyricsProvidersJSON');
    return decodeStringListResult(result, 'getLyricsProviders');
  }

  static Future<List<Map<String, dynamic>>>
  getAvailableLyricsProviders() async {
    final result = await _invokeI('getAvailableLyricsProvidersJSON');
  ...
  static Future<void> setLyricsFetchOptions(
    ...
    await _invokeI('setLyricsFetchOptionsJSON', {'options_json': optionsJSON});
  }

  static Future<Map<String, dynamic>> getLyricsFetchOptions() async {
    final result = await _invokeI('getLyricsFetchOptionsJSON');
  ...
  static Future<Map<String, dynamic>> getDeezerRelatedArtists(
    ...
    final result = await _invokeI('getDeezerRelatedArtists', {
      'artist_id': artistId,
      'limit': limit,
    });
  ...
  static Future<Map<String, dynamic>> getProviderMetadata(
    ...
    final future = _invokeCachedMap(
      ...
      _metadataCache,
      () async {
        final result = await _invokeI('getProviderMetadata', {
  ...
  static Future<Map<String, dynamic>> searchDeezerByISRC(
    ...
    final result = await _invokeI('searchDeezerByISRC', {
      'isrc': isrc,
      'item_id': itemId ?? '',
    });
  ...
  static Future<Map<String, String>?> getDeezerExtendedMetadata(
    ...
    try {
      final result = await _invokeI('getDeezerExtendedMetadata', {
        'track_id': trackId,
      });
  ...
  static Future<Map<String, dynamic>> convertSpotifyToDeezer(
    ...
    final future = _invokeCachedMap(
      ...
      _metadataCache,
      () async {
        final result = await _invokeI('convertSpotifyToDeezer', {
          'resource_type': resourceType,
          'spotify_id': spotifyId,
        });
  ...
  static Future<void> initExtensionSystem(
    ...
    await _invokeI('initExtensionSystem', {
  ...
  static Future<Map<String, dynamic>> loadExtensionsFromDir(
    ...
    final result = await _invokeI('loadExtensionsFromDir', {
      'dir_path': dirPath,
    });
  ...
  static Future<Map<String, dynamic>> loadExtensionFromPath(
    ...
    await _clearLookupCaches();
    final result = await _invokeI('loadExtensionFromPath', {
      'file_path': filePath,
    });
  ...
  static Future<Map<String, dynamic>> checkExtensionUpgrade(
    ...
    final result = await _invokeI('checkExtensionUpgrade', {
      'file_path': filePath,
    });
  ...
  static Future<List<Map<String, dynamic>>> getInstalledExtensions() async {
    final result = await _invokeI('getInstalledExtensions');
  ...
  static Future<void> setExtensionEnabled(
    ...
    await _clearLookupCaches();
    await _invokeI('setExtensionEnabled', {
  ...
  static Future<void> setProviderPriority(List<String> providerIds) async {
    ...
    await _clearLookupCaches();
    await _invokeI('setProviderPriorityJSON', {
      'priority': jsonEncode(providerIds),
    });
  }

  static Future<List<String>> getProviderPriority() async {
    final result = await _invokeI('getProviderPriorityJSON');
  ...
  static Future<void> setDownloadFallbackExtensionIds(
    ...
    await _clearLookupCaches();
    await _invokeI('setDownloadFallbackExtensionIdsJSON', {
  ...
  static Future<void> setMetadataProviderPriority(
    ...
    await _clearLookupCaches();
    await _invokeI('setMetadataProviderPriorityJSON', {
      'priority': jsonEncode(providerIds),
    });
  }

  static Future<List<String>> getMetadataProviderPriority() async {
    final result = await _invokeI('getMetadataProviderPriorityJSON');
  ...
  static Future<Map<String, dynamic>> getExtensionSettings(
    ...
    final result = await _invokeI('getExtensionSettingsJSON', {
      'extension_id': extensionId,
    });
  ...
  static Future<Map<String, dynamic>> checkExtensionHealth(
    ...
    final result = await _invokeI('checkExtensionHealth', {
      'extension_id': extensionId,
    });
  ...
  static Future<void> setExtensionSettings(
    ...
    await _clearLookupCaches();
    await _invokeI('setExtensionSettingsJSON', {
      'extension_id': extensionId,
  ...
  static Future<Map<String, dynamic>> invokeExtensionAction(
    ...
    final result = await _invokeI('invokeExtensionAction', {
      'extension_id': extensionId,
      'action': actionName,
    });
  ...
  static Future<List<Map<String, dynamic>>> searchTracksWithExtensions(
    ...
    final result = await _invokeI('searchTracksWithExtensions', {
      'query': query,
      'limit': limit,
    });
  ...
  static Future<List<Map<String, dynamic>>> searchTracksWithMetadataProviders(
    ...
    final result = await _invokeI('searchTracksWithMetadataProviders', {
      'query': query,
      'limit': limit,
  ...
  static Future<void> cleanupExtensions() async {
    ...
    await _invokeI('cleanupExtensions');
  }

  static Future<Map<String, dynamic>?> getExtensionPendingAuth(
    String extensionId,
  ) async {
    final result = await _invokeI('getExtensionPendingAuth', {
      'extension_id': extensionId,
    });
  ...
  static Future<void> setExtensionAuthCode(
    ...
    await _invokeI('setExtensionAuthCode', {
      'extension_id': extensionId,
      'auth_code': authCode,
    });
  }
  ...
  static Future<void> setExtensionTokens(
    ...
    await _invokeI('setExtensionTokens', {
      'extension_id': extensionId,
  ...
  static Future<void> clearExtensionPendingAuth(String extensionId) async {
    await _invokeI('clearExtensionPendingAuth', {'extension_id': extensionId});
  }

  static Future<bool> isExtensionAuthenticated(String extensionId) async {
    final result = await _invokeI('isExtensionAuthenticated', {
      'extension_id': extensionId,
    });
    return result as bool;
  }
  ...
  static Future<List<Map<String, dynamic>>> getAllPendingAuthRequests() async {
    final result = await _invokeI('getAllPendingAuthRequests');
  ...
  static Future<Map<String, dynamic>?> getPendingFFmpegCommand(
    ...
    final result = await _invokeI('getPendingFFmpegCommand', {
  ...
  static Future<void> setFFmpegCommandResult(
    ...
    await _invokeI('setFFmpegCommandResult', {
      'command_id': commandId,
      'success': success,
      'output': output,
      'error': error,
  ...
  getAllPendingFFmpegCommands() async {
    final result = await _invokeI('getAllPendingFFmpegCommands');
  ...
  static Future<List<Map<String, dynamic>>> customSearchWithExtension(
    ...
    final future =
        (() async {
          final result = await _invokeI('customSearchWithExtension', {
            'extension_id': extensionId,
            'query': query,
            'options': optionsJson,
  ...
  static Future<List<Map<String, dynamic>>> getSearchProviders() async {
    final result = await _invokeI('getSearchProviders');
  ...
  static Future<Map<String, dynamic>?> handleURLWithExtension(
    ...
    try {
      final result = await _invokeI('handleURLWithExtension', {'url': url});
  ...
  static Future<String?> findURLHandler(String url) async {
    final result = await _invokeI('findURLHandler', {'url': url});
    if (result == null || result == '') return null;
    return result as String;
  }

  static Future<List<Map<String, dynamic>>> getURLHandlers() async {
    final result = await _invokeI('getURLHandlers');
  ...
  static Future<Map<String, dynamic>?> getExtensionHomeFeed(
    ...
    final future =
        (() async {
          try {
            final result = await _invokeI('getExtensionHomeFeed', {
              'extension_id': extensionId,
              'request_id': requestId,
            });
  ...
  static Future<Map<String, dynamic>?> getExtensionBrowseCategories(
    ...
    try {
      final result = await _invokeI('getExtensionBrowseCategories', {
        'extension_id': extensionId,
      });
  ...
  static Future<void> setLibraryCoverCacheDir(String cacheDir) async {
    ...
    await _invokeI('setLibraryCoverCacheDir', {'cache_dir': cacheDir});
  }
  ...
  static Future<List<Map<String, dynamic>>> scanLibraryFolder(
    ...
    final result = await _invokeI('scanLibraryFolder', {
  ...
  static Future<Map<String, dynamic>> scanLibraryFolderIncremental(
    ...
    final result = await _invokeI('scanLibraryFolderIncremental', {
      'folder_path': folderPath,
  ...
  static Future<Map<String, dynamic>> scanLibraryFolderIncrementalFromSnapshot(
    ...
    final result = await _invokeI('scanLibraryFolderIncrementalFromSnapshot', {
      'folder_path': folderPath,
  ...
  static Future<List<Map<String, dynamic>>> scanSafTree(String treeUri) async {
    ...
    final result = await _invokeI('scanSafTree', {'tree_uri': treeUri});
  ...
  static Future<Map<String, dynamic>> scanSafTreeIncremental(
    ...
    final result = await _invokeI('scanSafTreeIncremental', {
      'tree_uri': treeUri,
      'existing_files': jsonEncode(existingFiles),
    });
  ...
  static Future<Map<String, dynamic>> scanSafTreeIncrementalFromSnapshot(
    ...
    final result = await _invokeI('scanSafTreeIncrementalFromSnapshot', {
      'tree_uri': treeUri,
      'snapshot_path': snapshotPath,
    });
    return decodeRequiredMapResultAsync(
  ...
  static Future<Map<String, int>> getSafFileModTimes(List<String> uris) async {
    final result = await _invokeI('getSafFileModTimes', {
  ...
  static Future<Map<String, dynamic>> getLibraryScanProgress() async {
    final result = await _invokeI('getLibraryScanProgress');
    return decodeMapResult(result);
  }
  ...
  static Future<void> cancelLibraryScan() async {
    await _invokeI('cancelLibraryScan');
  }
  ...
  static Future<List<Map<String, dynamic>>> getStoreExtensions({
    ...
    final result = await _invokeI('getStoreExtensionsJSON', {
  ...
  static Future<List<Map<String, dynamic>>> searchStoreExtensions(
    ...
    final result = await _invokeI('searchStoreExtensionsJSON', {
      'query': query,
      'category': category ?? '',
    });
  ...
  static Future<List<String>> getStoreCategories() async {
    final result = await _invokeI('getStoreCategoriesJSON');
  ...
  static Future<String> downloadStoreExtension(
    ...
    final result = await _invokeI('downloadStoreExtensionJSON', {
      'extension_id': extensionId,
      'dest_dir': destDir,
    });
    return result as String;
  ...
  static Future<void> clearStoreCache() async {
    ...
    await _invokeI('clearStoreCacheJSON');
  }
  ...
  static Future<Map<String, dynamic>> parseCueSheet(
    ...
    final result = await _invokeI('parseCueSheet', {
      'cue_path': cuePath,
      'audio_dir': audioDir,
    });
  ...
  static Future<String?> convertAudioFile(String inputPath) async {
    try {
      final result = await _invokeI('convertAudioFile', {
  ...
  static Future<Map<String, dynamic>?> readAudioMetadata(
    ...
    try {
      final result = await _invokeI('readAudioMetadata', {
        'file_path': filePath,
      });
  ...
  static Future<Map<String, dynamic>> runPostProcessing(
    ...
    final result = await _invokeI('runPostProcessing', {
      'file_path': filePath,
  ...
  static Future<Map<String, dynamic>> runPostProcessingV2(
    ...
    final result = await _invokeI('runPostProcessingV2', {
  ...
  static Future<List<Map<String, dynamic>>> getPostProcessingProviders() async {
    final result = await _invokeI('getPostProcessingProviders');
  ...
  static Future<String> playbackPlayTrack(String trackJson) async {
    final result = await _invokeI('playbackPlayTrack', {
  ...
  static Future<String> playbackPause() async {
    final result = await _invokeI('playbackPause');
    return result?.toString() ?? '{"success":false}';
  }

  static Future<String> playbackResume() async {
    final result = await _invokeI('playbackResume');
    return result?.toString() ?? '{"success":false}';
  }

  static Future<String> playbackStop() async {
    final result = await _invokeI('playbackStop');
    return result?.toString() ?? '{"success":false}';
  }

  static Future<String> playbackSeek(int positionMs) async {
    final result = await _invokeI('playbackSeek', {'position_ms': positionMs});
    return result?.toString() ?? '{"success":false}';
  }

  static Future<String> playbackNext() async {
    final result = await _invokeI('playbackNext');
    return result?.toString() ?? '{"success":false}';
  }

  static Future<String> playbackPrevious() async {
    final result = await _invokeI('playbackPrevious');
    return result?.toString() ?? '{"success":false}';
  }

  static Future<String> playbackSetQueue(String tracksJson) async {
    final result = await _invokeI('playbackSetQueue', {
  ...
  static Future<String> playbackAddToQueue(String tracksJson) async {
    final result = await _invokeI('playbackAddToQueue', {
      'tracks_json': tracksJson,
    });
    return result?.toString() ?? '{"success":false}';
  }
  ...
  static Future<Map<String, dynamic>> checkGitHubUpdate({
    ...
    final result = await _invokeI('checkGitHubUpdate', params);
    return decodeRequiredMapResult(result, 'checkGitHubUpdate');
  }

  // ============================================================
  // iOS Security-Scoped Bookmark Methods
  // ============================================================

  static Future<String?> createIosBookmarkFromPath(String path) async {
    try {
      final result = await _invokeI('createIosBookmarkFromPath', {'path': path});
      return result as String?;
    } catch (e) {
  ...
  static Future<String?> startAccessingIosBookmark(String bookmark) async {
    try {
      final result = await _invokeI('startAccessingIosBookmark', {
        'bookmark': bookmark,
      });
      return result as String?;
    } catch (e) {
  ...
  static Future<void> stopAccessingIosBookmark() async {
    try {
      await _invokeI('stopAccessingIosBookmark');
    } catch (e) {
