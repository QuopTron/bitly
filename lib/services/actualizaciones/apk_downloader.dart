/// Servicio para descargar e instalar actualizaciones APK desde URLs HTTPS.
/// Gestiona la descarga con progreso, validación de URL y dispara la
/// instalación vía [OpenFilex]. El nombre del archivo sigue el patrón
/// `Bitly-{version}.apk` en el directorio de almacenamiento externo.
library;
