...
// 2) El JS de re-marca a Bitly vive en panel_verificacion_branding_js.dart
//    (nodos de texto, chrome de nav, título, atributos visibles y
//    paleta). El widget Turnstile vive en un iframe y el puente
//    `SpotiflacGrant` es JS (no texto DOM), así ambos quedan intactos
//    y la verificación sigue funcionando.
