...
#   4. Compila el instalador con Inno Setup (scripts/build/instalador_windows.iss).
...
MSYS_NO_PATHCONV=1 "$ISCC" "/DMyAppVersion=$VERSION" scripts/build/instalador_windows.iss
