...
//   4. PremiumCache.activatePremium → persiste premium en drift (365 días)
...
import 'package:bitly/backend/cache/premium_cache.dart';
...
void main() {
  ...
  testWidgets('premium: activar código válido y gate permite descargas',
    ...
    await inj.sl<PremiumCache>().activatePremium(code);
    final stored = await inj.sl<PremiumCache>().getPremiumStatus();
    expect(stored.isPremium, isTrue, reason: 'drift debe guardar premium');
